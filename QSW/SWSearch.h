...
class MetaSpell : public QObject
{
    ...
    public slots:
        ...
        quint32 AttributesEx8() { return m_spellInfo->AttributesEx8; }
        quint32 AttributesEx9() { return m_spellInfo->AttributesEx9; }
        quint32 AttributesEx10() { return m_spellInfo->AttributesEx10; }
        quint32 Stances(quint8 index) { return m_spellInfo->getStances(index); }
        quint32 StancesNot(quint8 index) { return m_spellInfo->getStancesNot(index); }
        ...
        quint32 PowerDisplayId() { return m_spellInfo->getPowerDisplayId(); }
