    ...
    : QMainWindow(parent), m_pluginLoading(false)
{
    ...
    mainToolBar->addSeparator();
    m_actionSettings = mainToolBar->addAction(QIcon(":/png/cog.png"), "Settings");
    mainToolBar->addSeparator();
    m_actionWov = mainToolBar->addAction(QIcon(":/png/wand.png"), "Wov");
    mainToolBar->addSeparator();
    m_actionAbout = mainToolBar->addAction(QIcon(":/png/information.png"), "About");
...
{
    QAction* actionShow = new QAction(QIcon(":/png/application.png"), "Show", this);
    QAction* actionCompare = new QAction(QIcon(":/png/application_tile_horizontal.png"), "Compare", this);
