...
#define INSTANTIATE_SINGLETON_1(TYPE) \
    template class QSW_DLL_DECL ANATHEMA::Singleton<TYPE, ANATHEMA::SingleThreaded<TYPE>, ANATHEMA::OperatorNew<TYPE>, ANATHEMA::ObjectLifeTime<TYPE> >; \
...
#define INSTANTIATE_SINGLETON_2(TYPE, THREADINGMODEL) \
    template class QSW_DLL_DECL ANATHEMA::Singleton<TYPE, THREADINGMODEL, ANATHEMA::OperatorNew<TYPE>, ANATHEMA::ObjectLifeTime<TYPE> >; \
...
#define INSTANTIATE_SINGLETON_3(TYPE, THREADINGMODEL, CREATIONPOLICY ) \
    template class QSW_DLL_DECL ANATHEMA::Singleton<TYPE, THREADINGMODEL, CREATIONPOLICY, ANATHEMA::ObjectLifeTime<TYPE> >; \
...
#define INSTANTIATE_SINGLETON_4(TYPE, THREADINGMODEL, CREATIONPOLICY, OBJECTLIFETIME) \
    template class QSW_DLL_DECL ANATHEMA::Singleton<TYPE, THREADINGMODEL, CREATIONPOLICY, OBJECTLIFETIME >; \
