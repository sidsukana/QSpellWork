...
namespace SpellRange
{
    struct entry
    {
        ...
        quint32     flags;                                           // 5
        quint32     nameOffset[16];                                  // 6-21 unused
        quint32     nameFlags;                                       // 22 unused
        quint32     shortNameOffset[16];                             // 23-38 unused
...
namespace Spell
{
    ...
    struct entry
    {
        ...
        quint32    nameOffset[16];                                  // 136-151
        quint32    nameFlag;                                        // 152
        quint32    rankOffset[16];                                  // 153-168
        quint32    rankFlags;                                       // 169
        quint32    descriptionOffset[16];                           // 170-185 not used
        quint32    descriptionFlags;                                // 186     not used
        quint32    toolTipOffset[16];                               // 187-202 not used
