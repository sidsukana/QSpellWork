...
QString EffectString[] =
{
    ...
    QString("SPELL_EFFECT_41"),
    QString("SPELL_EFFECT_42"),
    QString("SPELL_EFFECT_TELEPORT_UNITS_FACE_CASTER"),
    QString("SPELL_EFFECT_SKILL_STEP"),
    QString("SPELL_EFFECT_UNDEFINED_45"),
    ...
    QString("SPELL_EFFECT_73"),
    QString("SPELL_EFFECT_74"),
    ...
    QString("SPELL_EFFECT_STEAL_BENEFICIAL_BUFF"),
    QString("SPELL_EFFECT_PROSPECTING"),
    QString("SPELL_EFFECT_APPLY_AREA_AURA_FRIEND"),
    QString("SPELL_EFFECT_APPLY_AREA_AURA_ENEMY"),
    QString("SPELL_EFFECT_REDIRECT_THREAT"),
    QString("SPELL_EFFECT_131"),
    QString("SPELL_EFFECT_PLAY_MUSIC"),
    QString("SPELL_EFFECT_UNLEARN_SPECIALIZATION"),
    QString("SPELL_EFFECT_KILL_CREDIT"),
    QString("SPELL_EFFECT_CALL_PET"),
    QString("SPELL_EFFECT_HEAL_PCT"),
    QString("SPELL_EFFECT_ENERGIZE_PCT"),
    QString("SPELL_EFFECT_LEAP_BACK"),
    QString("SPELL_EFFECT_CLEAR_QUEST"),
    QString("SPELL_EFFECT_FORCE_CAST"),
    QString("SPELL_EFFECT_141"),
    QString("SPELL_EFFECT_TRIGGER_SPELL_WITH_VALUE"),
    QString("SPELL_EFFECT_APPLY_AREA_AURA_OWNER"),
    QString("SPELL_EFFECT_144"),
    QString("SPELL_EFFECT_145"),
    QString("SPELL_EFFECT_146"),
    QString("SPELL_EFFECT_QUEST_FAIL"),
    QString("SPELL_EFFECT_148"),
    QString("SPELL_EFFECT_149"),
    QString("SPELL_EFFECT_150"),
    QString("SPELL_EFFECT_TRIGGER_SPELL_2"),
    QString("SPELL_EFFECT_152"),
    QString("SPELL_EFFECT_153")
};
...
QString AuraString[] =
{
    ...
    QString("SPELL_AURA_MOD_CRIT_DAMAGE_BONUS"),
    ...
    QString("SPELL_AURA_MOD_RESISTANCE_OF_STAT_PERCENT"),
    ...
    QString("SPELL_AURA_HASTE_MELEE"),
    QString("SPELL_AURA_HASTE_ALL"),
    QString("SPELL_AURA_MOD_DEPRICATED_1"),
    QString("SPELL_AURA_MOD_DEPRICATED_2"),
    QString("SPELL_AURA_MOD_COOLDOWN"),
    QString("SPELL_AURA_MOD_ATTACKER_SPELL_AND_WEAPON_CRIT_CHANCE"),
    QString("SPELL_AURA_MOD_ALL_WEAPON_SKILLS"),
    QString("SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT"),
    QString("SPELL_AURA_MOD_XP_PCT"),
    QString("SPELL_AURA_FLY"),
    QString("SPELL_AURA_IGNORE_COMBAT_RESULT"),
    QString("SPELL_AURA_MOD_ATTACKER_MELEE_CRIT_DAMAGE"),
    QString("SPELL_AURA_MOD_ATTACKER_RANGED_CRIT_DAMAGE"),
    QString("SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_DAMAGE"),
    QString("SPELL_AURA_MOD_FLIGHT_SPEED"),
    QString("SPELL_AURA_MOD_FLIGHT_SPEED_MOUNTED"),
    QString("SPELL_AURA_MOD_FLIGHT_SPEED_STACKING"),
    QString("SPELL_AURA_MOD_FLIGHT_SPEED_MOUNTED_STACKING"),
    QString("SPELL_AURA_MOD_FLIGHT_SPEED_NOT_STACKING"),
    QString("SPELL_AURA_MOD_FLIGHT_SPEED_MOUNTED_NOT_STACKING"),
    QString("SPELL_AURA_MOD_RANGED_ATTACK_POWER_OF_STAT_PERCENT"),
    QString("SPELL_AURA_MOD_RAGE_FROM_DAMAGE_DEALT"),
    QString("SPELL_AURA_214"),
    QString("SPELL_AURA_ARENA_PREPARATION"),
    QString("SPELL_AURA_HASTE_SPELLS"),
    QString("SPELL_AURA_217"),
    QString("SPELL_AURA_HASTE_RANGED"),
    QString("SPELL_AURA_MOD_MANA_REGEN_FROM_STAT"),
    QString("SPELL_AURA_MOD_RATING_FROM_STAT"),
    QString("SPELL_AURA_221"),
    QString("SPELL_AURA_222"),
    QString("SPELL_AURA_223"),
    QString("SPELL_AURA_224"),
    QString("SPELL_AURA_PRAYER_OF_MENDING"),
    QString("SPELL_AURA_PERIODIC_DUMMY"),
    QString("SPELL_AURA_PERIODIC_TRIGGER_SPELL_WITH_VALUE"),
    QString("SPELL_AURA_DETECT_STEALTH"),
    QString("SPELL_AURA_MOD_AOE_DAMAGE_AVOIDANCE"),
    QString("SPELL_AURA_230"),
    QString("SPELL_AURA_PROC_TRIGGER_SPELL_WITH_VALUE"),
    QString("SPELL_AURA_MECHANIC_DURATION_MOD"),
    QString("SPELL_AURA_233"),
    QString("SPELL_AURA_MECHANIC_DURATION_MOD_NOT_STACK"),
    QString("SPELL_AURA_MOD_DISPEL_RESIST"),
    QString("SPELL_AURA_236"),
    QString("SPELL_AURA_MOD_SPELL_DAMAGE_OF_ATTACK_POWER"),
    QString("SPELL_AURA_MOD_SPELL_HEALING_OF_ATTACK_POWER"),
    QString("SPELL_AURA_MOD_SCALE_2"),
    QString("SPELL_AURA_MOD_EXPERTISE"),
    QString("SPELL_AURA_FORCE_MOVE_FORWARD"),
    QString("SPELL_AURA_MOD_SPELL_DAMAGE_FROM_HEALING"),
    QString("SPELL_AURA_243"),
    QString("SPELL_AURA_COMPREHEND_LANGUAGE"),
    QString("SPELL_AURA_MOD_DURATION_OF_MAGIC_EFFECTS"),
    QString("SPELL_AURA_246"),
    QString("SPELL_AURA_247"),
    QString("SPELL_AURA_MOD_COMBAT_RESULT_CHANCE"),
    QString("SPELL_AURA_249"),
    QString("SPELL_AURA_MOD_INCREASE_HEALTH_2"),
    QString("SPELL_AURA_MOD_ENEMY_DODGE"),
    QString("SPELL_AURA_252"),
    QString("SPELL_AURA_253"),
    QString("SPELL_AURA_254"),
    QString("SPELL_AURA_255"),
    QString("SPELL_AURA_256"),
    QString("SPELL_AURA_257"),
    QString("SPELL_AURA_258"),
    QString("SPELL_AURA_259"),
    QString("SPELL_AURA_260"),
    QString("SPELL_AURA_261")
};
